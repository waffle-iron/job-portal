...
export class ClientTypeComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: ClientType) {
        return item.id;
    }
    registerChangeInClientTypes() {
        this.eventSubscriber = this.eventManager.subscribe('clientTypeListModification', (response) => this.reset());
    }

...
public class EducationResourceIntTest {
    ...
    public void setup() {
        ...
        EducationResource educationResource = new EducationResource(educationService);
    ...
    public void createEducation() throws Exception {
        ...
        assertThat(testEducation.getEducation()).isEqualTo(DEFAULT_EDUCATION);
    ...
    public void updateEducation() throws Exception {
        ...
        Education testEducation = educationList.get(educationList.size() - 1);
        assertThat(testEducation.getEducation()).isEqualTo(UPDATED_EDUCATION);
